...
export default function Header() {
  ...
  return (
    <header className="bg-gray-800 text-white relative">
      ...
      >
        <Link href="/about" className="text-2xl uppercase hover:text-neonGreen transition-colors" onClick={toggleMobileMenu}>
          About
        </Link>
        <Link href="/player" className="text-2xl uppercase hover:text-neonGreen transition-colors" onClick={toggleMobileMenu}>
          Player
        </Link>
        <Link href="/guests" className="text-2xl uppercase hover:text-neonGreen transition-colors" onClick={toggleMobileMenu}>
          Guests
        </Link>
        <Link href="/events" className="text-2xl uppercase hover:text-neonGreen transition-colors" onClick={toggleMobileMenu}>
          Events
        </Link>
        <Link href="/teams" className="text-2xl uppercase hover:text-neonGreen transition-colors" onClick={toggleMobileMenu}>
          Teams
        </Link>
      </div>
    </header>
