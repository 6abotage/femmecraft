            ...
            <div className="flex flex-col md:flex-row items-start justify-between">
              ...
              <div className="w-full md:w-1/2 md:pl-8">
                <p className="text-lg mb-6">
                  ...
                  brands to bring you unique experiences that celebrate
                  creativity and diversity. Our events provide a platform for
                  networking, learning, and showcasing the incredible talents
          ...
          <div className="container mx-auto">
            ...
            <div className="flex flex-col md:flex-row-reverse items-center justify-between">
              ...
              <div className="md:w-1/2">
                <p className="text-lg mb-6">
                  FEMMECRAFT was founded by Sarah Chen and Emma Johnson to
                  address the underrepresentation of BIPOC women in tech and
                  traditional crafts. Their vision was to create a platform that
                  celebrates diversity, fosters innovation, and builds a
                  supportive community. Today, FEMMECRAFT has grown into a
                  vibrant network of creators, innovators, and change-makers,
                  all working together to push the boundaries of technology and
                  craftsmanship.
                </p>
