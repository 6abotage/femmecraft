...
const teamMembers = [
  ...
  },
  {
    ...
    description:
      "Olivia ensures that every episode of FEMME CRAFT sounds crisp and professional, enhancing the listening experience for our audience. Her expertise in audio production and sound design creates an immersive auditory environment that brings our conversations to life, making complex topics accessible and engaging for all listeners.",
  ...
  },
  {
    ...
    description:
      "Zoe's network and communication skills help us bring diverse and inspiring guests to the show, enriching our content. Her talent for identifying unique voices in the tech and craft communities ensures that FEMME CRAFT always has fresh perspectives and exciting stories to share with our listeners.",
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <div className="w-full md:w-1/2 space-y-4">
                ...
                <p className="text-lg font-medium text-neonGreen">
                  {member.role}
                </p>
