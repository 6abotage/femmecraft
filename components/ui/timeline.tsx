  ...
  return (
    <div className="w-full  font-sans overflow-hidden" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-10 px-4 md:px-8 lg:px-10">
        <h1 className="text-5xl font-bold  mb-8">Unsere Reise</h1>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-green-500 via-neonGreen to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
